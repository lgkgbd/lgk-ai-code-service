...
const quickPrompts = reactive([
  {
    id: 1,
    title: '贪吃蛇游戏',
    description: '创建一个经典的贪吃蛇小游戏，支持键盘操控、计分和游戏结束重开',
    content: '创建一个贪吃蛇游戏，支持方向键控制蛇移动、吃到食物后身体变长并计分、撞墙或撞到自身则游戏结束并可重新开始，界面简洁美观、操作流畅，不超过200行代码'
  },
  {
    id: 2,
    title: '温柔的时钟',
    description: '创建一个风格温柔的时钟页面，柔和配色与平滑动画，实时显示当前时间',
    content: '创建一个温柔风格的时钟页面，实时显示当前时间和日期，采用柔和的配色和平滑的过渡动画，整体氛围温馨舒适、界面精致美观，不超过200行代码'
  },
  {
    id: 3,
    title: '毛玻璃风格的登录界面',
    description: '创建一个毛玻璃质感的登录界面，包含账号密码输入、记住我、第三方登录等',
    content: '创建一个毛玻璃（Glassmorphism）风格的登录界面，包含账号密码输入框、记住我、忘记密码、登录按钮和第三方登录入口，采用半透明磨砂玻璃质感和柔和渐变背景，设计精致现代，不超过200行代码'
  },
  {
    id: 4,
    title: '帝国的隐忍风格的话题社区',
    description: '创建一个"帝国隐忍"风格的话题社区，深沉大气的主题，支持话题讨论与互动',
    content: '创建一个"帝国隐忍"风格的话题社区，包含话题讨论、发帖回帖、用户互动、内容分享、评论系统等功能，采用深沉、大气、内敛克制的视觉风格，色调厚重庄重，不超过200行代码'
  },
])
