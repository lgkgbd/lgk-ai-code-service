...
const quickPrompts = reactive([
  {
    ...
    content: '创建一个波普风电商页面，包含商品展示、购物车、用户登录、订单管理、支付流程等功能，界面要具有波普艺术风格，色彩鲜艳，设计独特，不超过200行代码'
  },
  {
    id: 2,
    title: '企业网站',
    description: '创建一个专业的企业官网，包含公司介绍、产品服务、新闻动态、联系方式等',
    content: '创建一个企业网站，包含公司介绍、产品服务、新闻动态、团队介绍、联系方式等模块，设计要专业简洁，体现企业形象，不超过200行代码'
  },
  {
    id: 3,
    title: '电商运营后台',
    description: '创建一个电商运营管理后台，包含订单管理、商品管理、用户管理、数据分析等',
    content: '创建一个电商运营后台，包含订单管理、商品管理、用户管理、库存管理、数据分析看板等功能，界面要简洁易用，不超过200行代码'
  },
  {
    id: 4,
    title: '暗黑话题社区',
    description: '创建一个暗黑主题的社区论坛，包含话题讨论、用户互动、内容分享等功能',
    content: '创建一个暗黑话题社区，包含话题讨论、用户互动、内容分享、评论系统、用户等级等功能，采用暗黑主题设计，不超过200行代码'
  },
])
...
<template>
  <div class="community-home-page">
    ...
    <a-row :gutter="[16, 16]" style="height: calc(100vh - 200px); position: relative; z-index: 1;">
